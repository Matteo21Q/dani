...
n.t=n.t+1
out1D<-try(test.NI.survival(rnorm(100,0,0.5), rbinom(100,1,0.5), rep(0:1,each=50), 1.5))
...
out1E<-try(test.NI.survival(rnorm(100,100,1), "100", rep(0:1,each=50), 1.5))
...
n.t=n.t+1
out1F<-try(test.NI.survival(rnorm(100,100,1), c(0,1), rep(0:1,each=50), 1.5))
...
out1G<-try(test.NI.survival(rnorm(100,100,1), rbinom(100,1,0.5), "pippo", 1.5))
...
n.t=n.t+1
out1H<-try(test.NI.survival(rnorm(100,100,1), rbinom(100,1,0.5), rep(0:1,each=250), 1.5))
...
out2A<-try(test.NI.survival(rnorm(100,100,1), rbinom(100,1,0.5), rep(0:1,each=50), "1.5"))
...
n.t=n.t+1
out2B<-try(test.NI.survival(rnorm(100,100,1), rbinom(100,1,0.5), rep(0:1,each=50), 1))
...
n.t=n.t+1
out2C<-try(test.NI.survival(rnorm(100,100,1), rbinom(100,1,0.5), rep(0:1,each=50), 1.5, unfavourable = F))
...
n.t=n.t+1
out2D<-try(test.NI.survival(rnorm(100,100,1), rbinom(100,1,0.5), rep(0:1,each=50), unfavourable=F, -1))
correct[[n.t]]<-ifelse((inherits(out2D, "try-error"))&&(grepl("NI.margin > 0 is not TRUE", out2D[1] , fixed=T )),1,0) 
names(correct)[[n.t]]<-"out2D"
n.t=n.t+1
out2E<-try(test.NI.survival(rnorm(100,100,1), rbinom(100,1,0.5), rep(0:1,each=50), 1, summary.measure="DRMST", tau=5))
...
n.t=n.t+1
out2F<-try(test.NI.survival(rnorm(100,100,1), rbinom(100,1,0.5), rep(0:1,each=50), -1, summary.measure="DRMST", unfavourable=F, tau=5))
...
n.t=n.t+1
out2G<-try(test.NI.survival(rnorm(100,100,1), rbinom(100,1,0.5), rep(0:1,each=50), 0.1, summary.measure="DS", tau=5))
...
n.t=n.t+1
out2H<-try(test.NI.survival(rnorm(100,100,1), rbinom(100,1,0.5), rep(0:1,each=50), -0.1, summary.measure="DS", unfavourable=F, tau=5))
...
out3A<-try(test.NI.survival(rnorm(100,100,1), rbinom(100,1,0.5), rep(0:1,each=50), 1.5, sig.level="0.025"))
...
n.t=n.t+1
out3B<-try(test.NI.survival(rnorm(100,100,1), rbinom(100,1,0.5), rep(0:1,each=50), 1.5, sig.level=-0.1))
correct[[n.t]]<-ifelse((inherits(out3B, "try-error"))&&(grepl("sig.level > 0 is not TRUE", out3B[1] , fixed=T )),1,0) 
names(correct)[[n.t]]<-"out3B"
n.t=n.t+1
out3C<-try(test.NI.survival(rnorm(100,100,1), rbinom(100,1,0.5), rep(0:1,each=50), 1.5, sig.level=0.7))
...
out4A<-try(test.NI.survival(rnorm(100,100,1), rbinom(100,1,0.5), rep(0:1,each=50), 1.5, summary.measure = "pippo"))
...
out4B<-try(test.NI.survival(rnorm(100,100,1), rbinom(100,1,0.5), rep(0:1,each=50), 1.5,  print.out = NA))
...
out4C<-try(test.NI.survival(rnorm(100,100,1), rbinom(100,1,0.5), rep(0:1,each=50), 1.5,  test.type = "pippo"))
...
out4D<-try(test.NI.survival(rnorm(100,100,1), rbinom(100,1,0.5), rep(0:1,each=50), 1.5,  unfavourable = "pippo"))
...
out4E<-try(test.NI.survival(rnorm(100,100,1), rbinom(100,1,0.5), rep(0:1,each=50), 1.5, test.type="Cox.PH.bootstrap", M.boot="2000"))
...
n.t=n.t+1
out4F<-try(test.NI.survival(rnorm(100,100,1), rbinom(100,1,0.5), rep(0:1,each=50), 1.5, test.type="Cox.PH.bootstrap", M.boot=1))
...
out4G<-try(test.NI.survival(rnorm(100,100,1), rbinom(100,1,0.5), rep(0:1,each=50), 1.5, summary.measure="DRMST"))
correct[[n.t]]<-ifelse((inherits(out4G, "try-error"))&&(grepl("is.numeric(tau) is not TRUE", out4G[1] , fixed=T )),1,0) 
names(correct)[[n.t]]<-"out4G"
n.t=n.t+1
out4H<-try(test.NI.survival(rnorm(100,100,1), rbinom(100,1,0.5), rep(0:1,each=50), 1.5, summary.measure="DRMST", tau=-1))
...
out5A<-try(test.NI.survival(time1, event1, treat1, 1.5))
...
n.t=n.t+1
out5B<-try(test.NI.survival(time1, event1, treat1, 2))
correct[[n.t]]<-ifelse((inherits(out5B,"list"))&&(all.equal(out5B$CI[2],1.874577, tolerance=10^(-6))),1,0) 
names(correct)[[n.t]]<-"out5B"
n.t=n.t+1
out5C<-try(test.NI.survival(time1, event1, treat1, 1.5, test.type="flexsurv.PH"))
...
out6A<-try(test.NI.survival(time1, event1, treat1, -1, summary.measure="DRMST", tau=100))
...
n.t <- n.t + 1
out6B<-try(test.NI.survival(time1, event1, treat1, -0.5, summary.measure="DRMST", tau=100))
...
n.t <- n.t + 1
out6C<-try(test.NI.survival(time1, event1, treat1, 1, unfavourable=F, summary.measure="DRMST", tau=100))
...
n.t <- n.t + 1
out6D<-try(test.NI.survival(time1, event1, treat1, -1, sig.level=0.05, summary.measure="DRMST", tau=100))
correct[[n.t]] <- ifelse((is.list(out6D)) && (all.equal(out6D$CI[2], -0.3695133, tolerance=10^(-6))), 1, 0)
names(correct)[[n.t]] <- "out6D"
n.t <- n.t + 1
out6E<-try(test.NI.survival(time1, event1, treat1, -1, summary.measure="DRMST", test.type="KM", tau=100))
correct[[n.t]] <- ifelse((is.list(out6E)) && (all.equal(out6E$CI[2], 0.6416595, tolerance=10^(-6))), 1, 0)
names(correct)[[n.t]] <- "out6E"
n.t <- n.t + 1
set.seed(1)
out6F<-try(test.NI.survival(time1, event1, treat1, -1, summary.measure="DRMST", test.type="Cox.PH.bootstrap", tau=100))
correct[[n.t]] <- ifelse((is.list(out6F)) && (all.equal(out6F$CI[2], 0.274423, tolerance=10^(-6))), 1, 0)
names(correct)[[n.t]] <- "out6F"
n.t <- n.t + 1
set.seed(1)
out6G<-try(test.NI.survival(time1, event1, treat1, -1, summary.measure="DRMST", test.type="flexsurv.PH.bootstrap", tau=100, M.boot = 20))
correct[[n.t]] <- ifelse((is.list(out6G)) && (all.equal(out6G$CI[2], 0.1114428, tolerance=10^(-6))), 1, 0) 
...
out7A<-try(test.NI.survival(time1, event1, treat1, -0.1, summary.measure="DS", tau=100))
...
n.t <- n.t + 1
out7B<-try(test.NI.survival(time1, event1, treat1, -0.05, summary.measure="DS", tau=100))
...
n.t <- n.t + 1
out7C<-try(test.NI.survival(time1, event1, treat1, -0.1, sig.level=0.05, summary.measure="DS", tau=100))
...
n.t <- n.t + 1
out7D<-try(test.NI.survival(time1, event1, treat1, -0.1, summary.measure="DS", test.type="Newcombe10", tau=100))
correct[[n.t]] <- ifelse((is.list(out7D)) && (all.equal(out7D$CI[2], 0.01249202, tolerance=10^(-6))), 1, 0) 
names(correct)[[n.t]] <- "out7D"
n.t <- n.t + 1
set.seed(1)
out7E<-try(test.NI.survival(time1, event1, treat1, -0.1, summary.measure="DS", test.type="Cox.PH.bootstrap", tau=100))
correct[[n.t]] <- ifelse((is.list(out7E)) && (all.equal(out7E$CI[2], 0.03796869, tolerance=10^(-6))), 1, 0) 
names(correct)[[n.t]] <- "out7E"
n.t <- n.t + 1
out7F<-try(test.NI.survival(time1, event1, treat1, 0.1, unfavourable=F, summary.measure="DS", tau=100))
correct[[n.t]] <- ifelse((is.list(out7F)) && (all.equal(out7F$CI[2], -0.04978398, tolerance=10^(-6))), 1, 0) 
names(correct)[[n.t]] <- "out7F"
n.t <- n.t + 1
set.seed(1)
out7G<-try(test.NI.survival(time1, event1, treat1, -0.1, summary.measure="DS", test.type="flexsurv.PH.bootstrap", tau=100, M.boot=20))
correct[[n.t]] <- ifelse((is.list(out7G)) && (all.equal(out7G$CI[2], 0.01809042, tolerance=10^(-6))), 1, 0) 
