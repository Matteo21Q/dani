...
correct[[n.t]] <- ifelse((is.list(out6A)) && (all.equal(out6A$CI[2], -0.3327035, tolerance=10^(-5))) && out6A$non.inferiority, 1, 0) 
names(correct)[[n.t]] <- "out6A"
n.t <- n.t + 1
out6B<-try(test.NI.survival(time1, event1, treat1, NI.margin=-0.5, summary.measure="DRMST", tau=100))
correct[[n.t]] <- ifelse((is.list(out6B)) && (all.equal(out6B$CI[2], -0.3327035, tolerance=10^(-5))) && !out6B$non.inferiority, 1, 0)
...
correct[[n.t]] <- ifelse((is.list(out6C)) && (all.equal(out6C$CI[2], -0.3327035, tolerance=10^(-5))) && out6C$non.inferiority, 1, 0)
...
correct[[n.t]] <- ifelse((is.list(out6D)) && (all.equal(out6D$CI[2], -0.3550846, tolerance=10^(-6))), 1, 0)
...
correct[[n.t]] <- ifelse((is.list(out6G)) && (all.equal(out6G$CI[2], 0.387844, tolerance=10^(-6))), 1, 0) 
...
correct[[n.t]] <- ifelse((is.list(out7A)) && (all.equal(out7A$CI[2], -0.04739627, tolerance=10^(-5))) && out7A$non.inferiority == TRUE, 1, 0) 
names(correct)[[n.t]] <- "out7A"
n.t <- n.t + 1
out7B<-try(test.NI.survival(time1, event1, treat1, NI.margin= -0.05, summary.measure="DS", tau=100))
correct[[n.t]] <- ifelse((is.list(out7B)) && (all.equal(out7A$CI[2], -0.04739627, tolerance=10^(-5))) && out7B$non.inferiority == FALSE, 1, 0) 
...
correct[[n.t]] <- ifelse((is.list(out7C)) && (all.equal(out7C$CI[2], -0.04978029, tolerance=10^(-5))) && out7C$non.inferiority == TRUE, 1, 0) 
...
correct[[n.t]] <- ifelse((is.list(out7F)) && (all.equal(out7F$CI[2], -0.04739627, tolerance=10^(-6))), 1, 0) 
...
correct[[n.t]] <- ifelse((is.list(out7G)) && (all.equal(out7G$CI[2], 0.02550996, tolerance=10^(-6))), 1, 0) 
