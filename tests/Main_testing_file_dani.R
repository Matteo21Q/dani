...
source("samplesize.ROCI.survival.R")
...
source("samplesize.ROCI.survival testing file.R")
...
source("test.ROCI.survival testing file.R")
...
results<-c(cm.b, cm.c, cm.s, c.NIf.b, c.NIf.c, c.NIf.s, ss.NI.b, ss.NI.c, ss.NI.s, ss.NIf.b,
           ss.ROCI.b, ss.ROCI.s, t.NI.b, t.NI.c, t.NI.s, t.NIf.b, t.ROCI.b, t.ROCI.s, pw.NI.b, pw.NI.c, pw.NIf.b, 
           pw.ROCI.b, t1e.NIf.b)
name.results<-c("convertmargin.binary", "convertmargin.continuous", "convertmargin.survival",
                ...
                "samplesize.NIfrontier.binary", "samplesize.ROCI.binary", "samplesize.ROCI.survival",
                "test.NI.binary", "test.NI.continuous", "test.NI.survival", "test.ROCI.survival",
